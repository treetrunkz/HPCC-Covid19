...
const TravelForm = (props: Props) => {
  ...
  const getFields = () => {
    ...
    for (let i = 0; i < count; i++) {
      children.push(
        <Row key={i} style={{padding: 2, paddingLeft: '15%', paddingRight: '15%'}}>
          <Col span={12}>
            <Form.Item
              name={`${i}.countryCode`}
              label={`Country`}
  ...
  return (
    <Modal visible={props.visible} onCancel={() => props.onClose()}  width={1400} style={{ top: 5 }} 
          footer={[
            <Button type="primary" key="ok" onClick={() => props.onClose()}>
              Ok
            </Button>
          ]}
          title = "Travel Form"
    >
      ...
      <Layout style={{height: 1000}}>
        <Layout style={{paddingTop: 20, paddingLeft: 10, paddingBottom: '2%'}}>
          <Form
          ...
          >
            ...
            <Row>
              <Col>
            <Form.Item {...tailLayout}  style={{paddingBottom: 20}}>
